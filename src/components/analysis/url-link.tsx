...
import { Link, AlertTriangle, ShieldAlert, Skull } from "lucide-react"
...
export function URLLink({ url, score, className }: URLLinkProps) {
  ...
  const handleUrlClick = useCallback(() => {
    if (needsWarning) {
      // Show warning dialog
      console.log('[URLLink] Warning shown for score:', score)
  ...
  const handleContinueAtOwnRisk = useCallback(() => {
    ...
    console.log('[URLLink] User confirmed navigation despite warning, score:', score)
    window.open(url, '_blank', 'noopener,noreferrer')
  }, [url, score])
  
  const handleCancel = useCallback(() => {
    setIsDialogOpen(false)
    console.log('[URLLink] User cancelled navigation, score:', score)
  }, [score])
